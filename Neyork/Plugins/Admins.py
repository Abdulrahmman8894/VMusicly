...
from Neyork.Database import (is_active_chat, is_music_playing, music_off,
                            music_on, remove_active_chat)
from Neyork.Decorators.admins import AdminRightsCheck
from Neyork.Decorators.checker import checker, checkerCB
from Neyork.Inline import audio_markup, primary_markup
...
async def admins(_, message: Message):
    ...
    if message.command[0][1] == "e":
        ...
        await Neyork.pytgcalls.resume_stream(message.chat.id)
        await message.reply_text(
    ...
    if message.command[0][1] == "t" or message.command[0][1] == "n":
        ...
        await Neyork.pytgcalls.leave_group_call(message.chat.id)
        await message.reply_text(

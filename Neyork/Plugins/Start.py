...
from Neyork import ASSID, BOT_ID, MUSIC_BOT_NAME, OWNER_ID, SUDOERS, app
from Neyork import boottime as bot_start_time
from Neyork import db
from Neyork.Core.PyTgCalls import Neyork
from Neyork.Database import (add_nonadmin_chat, add_served_chat,
...
from Neyork.Decorators.admins import ActualAdminCB
from Neyork.Decorators.permission import PermissionCheck
from Neyork.Inline import (custommarkup, dashmarkup, setting_markup, setting_markup2,
                          start_pannel, usermarkup, volmarkup)
from Neyork.Utilities.ping import get_readable_time
...
async def start_markup_check(_, CallbackQuery):
    ...
    if command == "LV":
        ...
        volume = 25
        try:
            await Neyork.pytgcalls.change_volume_call(c_id, volume)
    ...
    if command == "DIT":
        ...
        await CallbackQuery.answer(
            f"Prime Disk Usage: {diske}%", show_alert=True
        )

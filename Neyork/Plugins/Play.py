...
from Neyork import (BOT_USERNAME, DURATION_LIMIT, DURATION_LIMIT_MIN,
                   MUSIC_BOT_NAME, app, db_mem)
from Neyork.Core.PyTgCalls.Converter import convert
from Neyork.Core.PyTgCalls.Downloader import download
from Neyork.Decorators.assistant import AssistantAdd
from Neyork.Decorators.checker import checker
from Neyork.Decorators.permission import PermissionCheck
from Neyork.Inline import (playlist_markup, search_markup, search_markup2,
                          url_markup, url_markup2)
from Neyork.Utilities.changers import seconds_to_min, time_to_seconds
from Neyork.Utilities.chat import specialfont_to_normal
from Neyork.Utilities.stream import start_stream, start_stream_audio
from Neyork.Utilities.theme import check_theme
from Neyork.Utilities.thumbnails import gen_thumb
from Neyork.Utilities.url import get_url
from Neyork.Utilities.youtube import (get_yt_info_id, get_yt_info_query,
...
@app.on_callback_query(filters.regex(pattern=r"Neyork"))

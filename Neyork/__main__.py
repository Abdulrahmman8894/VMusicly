...
from Neyork import (ASSID, ASSMENTION, ASSNAME, ASSUSERNAME, BOT_ID, BOT_NAME,
                   BOT_USERNAME, SUDOERS, app, db, userbot)
from Neyork.Core.Logger.Log import (startup_delete_last, startup_edit_last,
                                   startup_send_new)
from Neyork.Core.PyTgCalls.Neyork import run
from Neyork.Database import get_active_chats, get_sudoers, remove_active_chat
from Neyork.Inline import private_panel
from Neyork.Plugins import ALL_MODULES
from Neyork.Utilities.inline import paginate_modules
...
async def initiate_bot():
    with console.status(
        "[magenta] Booting up The Neyork Music Bot...",
    ) as status:
    ...
    console.print(
        "[bold green]Congrats!! Neyork Music Bot has started successfully!\n"
    )
    try:
    ...
    try:
        ...
        return
    try:
        await userbot.join_chat("xU_S_A1")
    except:
        pass

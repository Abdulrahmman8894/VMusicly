...
from Neyork import BOT_USERNAME, db_mem
from Neyork.Core.PyTgCalls import Queues, Neyork
from Neyork.Database import (add_active_chat, is_active_chat, music_off,
                            music_on)
from Neyork.Inline import (audio_markup, audio_markup2, primary_markup,
                          secondary_markup)
